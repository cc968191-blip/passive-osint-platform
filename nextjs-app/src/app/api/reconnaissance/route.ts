...
const SCRIPT_SRC_SIGS: [RegExp, string, string][] = [
  ...
  [/backbone/i, "Backbone.js", "JavaScript Framework"],
  ...
  [/sentry/i, "Sentry", "Error Tracking"],
  [/bugsnag/i, "Bugsnag", "Error Tracking"],
  ...
  [/slick/i, "Slick Carousel", "UI Library"],
...
const LINK_HREF_SIGS: [RegExp, string, string][] = [
  ...
  [/foundation/i, "Foundation", "CSS Framework"],
...
const HTML_BODY_SIGS: [RegExp, string, string][] = [
  ...
  // Misc
  [/data-turbo|turbolinks/i, "Turbo/Turbolinks", "JavaScript Library"],
...
async function queryTechnologies(domain: string, siteData?: { resp: Response; html: string }) {
  ...
  try {
    ...
    if (/gatsby/i.test(inlineAll)) add("Gatsby", "Static Site Generator", "medium");
